...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** Recupero eventuali dati passati da intent */

        if(this.getCallingActivity() != null){
            sessionTimedOut = getIntent().getExtras().getBoolean("sessionTimedOut");
        }
    ...
    protected void onStart() {
        ...
        if(sessionTimedOut)
            Toast.makeText(this, R.string.session_timeded_out, Toast.LENGTH_LONG).show();
            ...
            mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Intent intent = new Intent(LoginActivity.this, TakeAPicture.class);
